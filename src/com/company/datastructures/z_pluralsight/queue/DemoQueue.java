package com.company.datastructures.z_pluralsight.queue;

public class DemoQueue {

    BasicQueue<Gad2Chair> basicQueue = new BasicQueue<>();
    ...
    public void run(){
        ...
        System.out.println("Lift has Mary and Anna on it: " + basicQueue.contains(new Gad2Chair("Mary", "Anna")));

        //who's at the 2nd position - remember 0 based index
        System.out.println("2nd chair has: " + basicQueue.access(1).listChairRiders());
    ...
    private void loadLift() {
        ...
        basicQueue.enQueue(chair1);
        basicQueue.enQueue(chair2);
        basicQueue.enQueue(chair3);
        basicQueue.enQueue(chair4);
        basicQueue.enQueue(chair5);
    }

    private void unloadLift() {
        Gad2Chair chair = basicQueue.deQueue();

        //should be John and Dave
        System.out.println(chair.listChairRiders());

        chair = basicQueue.deQueue();
    ...
    class Gad2Chair {
        ...
        private DemoQueue getOuterType() {
            return DemoQueue.this;
        }
    }
}
